...
// Partial specialization: Different implementation when ONE the template parameters is a specific value
template<typename T>
...
public:
	...
	void Print() {
		std::cout << "Defauly size detected. Using 80 Columns:" << std::endl;
		std::cout << "{" << *m_pData << "}" << std::endl;
	}
	T* GetData() {
		return m_pData;
